...
var Editor = /** @class */ (function () {
    function Editor(context) {
        ...
        this.history = new History_1["default"](context);
    ...
    Editor.prototype.initialize = function () {
        ...
        this.$editable.on('keydown', function (event) {
            ...
            _this.hasKeyShortCut = false;
            if (!event.isDefaultPrevented()) {
                if (_this.options.shortcuts) {
                    _this.hasKeyShortCut = _this.handleKeyMap(event);
                }
                else {
            ...
            if (_this.options.recordEveryKeystroke) {
                if (_this.hasKeyShortCut === false) {
     ...
     * @return {WrappedRange}
     */
    Editor.prototype.createRangeFromList = function (lst) {
        var startRange = range_1["default"].createFromNodeBefore(lists_1["default"].head(lst));
        var startPoint = startRange.getStartPoint();
        var endRange = range_1["default"].createFromNodeAfter(lists_1["default"].last(lst));
        var endPoint = endRange.getEndPoint();
        return range_1["default"].create(startPoint.node, startPoint.offset, endPoint.node, endPoint.offset);
    };
    /**
     * set the last range
     *
        ...
        if (rng !== '') {
            ...
            if (rng.isCollapsed()) {
                ...
                if (firstSpan && !dom_1["default"].nodeLength(firstSpan)) {
                    ...
                    range_1["default"].createFromNode(firstSpan.firstChild).select();
                    this.setLastRange();
