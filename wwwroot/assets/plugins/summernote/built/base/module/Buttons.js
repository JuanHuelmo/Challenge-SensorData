            ...
            children: [
                ...
                this.ui.dropdown({
                    ...
                    click: function (event) {
                        ...
                        var $parent = jquery_1["default"]('.' + className).find('.note-dropdown-menu');
                        ...
                        if (eventName === 'openPalette') {
                            ...
                            if (lists_1["default"].contains(['backColor', 'foreColor'], eventName)) {
    ...
    Buttons.prototype.addToolbarButtons = function () {
                ...
                _this.ui.dropdown({
                    ...
                    template: function (item) {
                        ...
                        if (typeof item === 'string') {
                            item = {
                                tag: item,
                                title: (Object.prototype.hasOwnProperty.call(_this.lang.style, item) ? _this.lang.style[item] : item)
                            };
                        }
                        var tag = item.tag;
        ...
        this.context.memo('button.fontsizeunit', function () {
            return _this.ui.buttonGroup([
                _this.button({
                    className: 'dropdown-toggle',
                    contents: _this.ui.dropdownButtonContents('<span class="note-current-fontsizeunit"></span>', _this.options),
